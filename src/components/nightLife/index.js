...
import nightRecord from "../../data/nightLife";
import Filters from "../common/filters"; 
import ExploreSection from "../common/exploreSection";
import Collections from "../common/collection";
...
const Nightlife = () =>{
    return(
        <div>
            ...
            <ExploreSection list={nightLifeList} collectionName= "Nightlife Restaurants in Coimbatore"/> 
        </div>
    )
} 
